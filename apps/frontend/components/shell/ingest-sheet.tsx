                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <input
                          ...
                          disabled={isLoading}
                        />
                        <Upload className={cn("h-10 w-10 mb-3 transition-all", isDragging ? "text-primary scale-110" : "text-muted-foreground")} />
                            ...
                            <AnimatePresence>
                              {files.map((file, index) => (
                                <motion.div
                                  ...
                                  exit={{ opacity: 0, x: 20 }}
                                  className="flex items-center justify-between gap-2 mb-2 last:mb-0 p-2 rounded-xl bg-muted/40 hover:bg-muted/60 transition-colors"
                                >
                      ...
                      <p className="text-xs text-muted-foreground">
                        I file vengono caricati in una directory fissa nel container Docker e poi elaborati.
                      </p>
                    </div>
                  </TabsContent>
                                ...
                                <div className="space-y-2">
                                  {result.errors.map((error, idx) => (
                                    <motion.div
                                      ...
                                      className="rounded-xl bg-destructive/10 border border-destructive/20 p-3 text-xs"
                                    >
                                      <div className="flex items-start gap-2">
                                        <AlertCircle className="h-3.5 w-3.5 text-destructive mt-0.5 flex-shrink-0" />
                                        <p className="text-destructive font-mono break-all">{error}</p>
                                      </div>
                                    </motion.div>
                                  ))}
                                </div>
